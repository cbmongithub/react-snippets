...
const ComponentPlayground: React.FC<ComponentPlaygroundProps> = ({
  ...
  return (
    <div className={componentPlaygroundCva({ isCentered, className })}>
      <div className='absolute size-full bg-[linear-gradient(to_right,#b1b1b12e_1px,transparent_1px),linear-gradient(to_bottom,#b1b1b12e_1px,transparent_1px)] bg-[size:14px_14px] [mask-image:radial-gradient(ellipse_50%_50%_at_50%_50%,#000_10%,transparent_100%)]'></div>
