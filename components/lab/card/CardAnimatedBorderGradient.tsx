const CardAnimatedBorderGradient = () => {
  return (
    <div className='relative h-48 w-48 overflow-hidden rounded-xl border border-neutral-800 p-[1px] backdrop-blur-3xl'>
      ...
      <div className='inline-flex h-full w-full items-center justify-center rounded-xl bg-neutral-950 px-3 py-1 text-sm font-medium text-neutral-50 backdrop-blur-3xl' />
    </div>
  );
};
