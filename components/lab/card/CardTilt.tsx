...
const CardTilt = () => {
  ...
  return (
    <>
      ...
      >
        <div className='group relative flex h-full w-full select-none items-center justify-center rounded-lg border border-neutral-900 bg-gradient-to-tr from-neutral-950 to-neutral-900 text-sm font-light text-neutral-300'>
