...
const CardImage = () => {
    return (
        <CardSpotlight>
            <div className="relative flex flex-row z-0 w-full rounded-2xl my-6 bg-gradient-to-tl from-transparent via-transparent to-neutral-900 sm:flex-row">
                <div className="w-full h-48 mt-[-25px] sm:mt-0 sm:w-2/5 shrink-0 overflow-hidden rounded-2xl">
                    <Image
                        ...
                        alt="Striking neon blue lights from the coral reefs"
                        height={360}
                        width={480}
                ...
                <div className="p-6">
                    ...
                    <div className="inline-flex flex-row justify-evenly mt-4 space-x-4">
                        <Link
                            href="#"
                            className="z-30 text-sm text-blue-500 hover:text-blue-600"
