const InputPulseBorder = () => {
  return (
    <div className='relative'>
      ...
      <input
        className='block h-12 w-full rounded-md border border-neutral-800 bg-neutral-950 px-3 py-2 focus:outline-none focus:ring-1 focus:ring-neutral-400 focus:ring-offset-1 focus:ring-offset-neutral-50'
