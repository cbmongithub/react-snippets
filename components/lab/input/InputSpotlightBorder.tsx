    ...
    <>
      <div className='relative w-full'>
        <input
          ...
          type='email'
          name='email'
          className='h-12 w-full cursor-default rounded-md border border-neutral-800 bg-neutral-950 p-3.5 text-neutral-100 transition-colors duration-500 placeholder:select-none  placeholder:text-neutral-500 focus:border-[#8678F9] focus:outline-none'
        />
        <input
          ref={divRef}
          disabled
